...
public class TransferMoneyFromQualityHomepage implements Screen {
	
	public static final TransferMoneyFromQualityHomepage tmfq=new TransferMoneyFromQualityHomepage();
